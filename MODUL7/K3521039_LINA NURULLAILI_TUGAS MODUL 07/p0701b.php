<?php
session_start();
if ($_SESSION['pilih']=="Ruang1") {
    $jawaban = "Hai " . $_SESSION['name'] . ", Selamat Menonton";
    $youtube = "<iframe width='560' height='315' src='https://www.youtube.com/embed/kgvL6n6Bih8' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
} else {
