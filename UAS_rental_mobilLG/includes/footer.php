    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <font color="white">Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>. RENTAL MOBIL LINGA.</font>
        </div>
      </div>
    </div>
  </div>
