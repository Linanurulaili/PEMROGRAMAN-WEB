    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/oke.png" alt="image" width="150px" height="100px" /></a> </div>
        </div>
        <div class="col-sm-10 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">RentalMobil_LinGa@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Hubungi :</p>
              <a href="tel:61-1234-5678-99">0898765432</a> </div>
            </div>
