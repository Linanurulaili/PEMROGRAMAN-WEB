			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Rental Mobi LinGa</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Rental Mobil LinGa</h2></td>
					</tr>
					<tr>
						<td class="text-center">Jl. Ahmad Yani No. 200 Kampus V FKIP UNS Pabelan Surakarta</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
