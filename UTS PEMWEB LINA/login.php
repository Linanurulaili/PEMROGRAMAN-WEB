...
if( isset($_POST['submit']) ){
        ...
        $name     = stripslashes($_POST['namaPemilik']);
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass)) && !empty(trim($namaUsaha)) && !empty(trim($alamat))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO users (username,namaPemilik ,email, password,namaUsaha,alamat) VALUES ('$username','$name','$email','$pass')";
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="login.php" method="POST">
                    ...
                    <div class="form-footer mt-2">
                        <p> Belum punya account? <a href="regitrasi.php">Register</a></p>
                    </div>
                </form>
            </section>
            </section>
